...
function Invoke-MusicControl {
    ...
    switch ($ControlAction) {
        'play' { $success = [YouTubeMusic]::PlayPause($hWnd); break }
        'pause' { $success = [YouTubeMusic]::PlayPause($hWnd); break }
        'next' { $success = [YouTubeMusic]::NextTrack($hWnd); break }
        'prev' { $success = [YouTubeMusic]::PreviousTrack($hWnd); break }
        'previous' { $success = [YouTubeMusic]::PreviousTrack($hWnd); break }
        'volumeUp' { $success = [YouTubeMusic]::VolumeUp($hWnd); break }
        'volumeDown' { $success = [YouTubeMusic]::VolumeDown($hWnd); break }
        'mute' { 
...
switch ($selection) {
    "Play/Pause" { Invoke-MusicControl 'play' }
